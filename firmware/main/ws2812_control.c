...
#define T0H	14  // 0 bit high time (0.3 * 96/2)
#define T1H	29 // 1 bit high time (0.6 * 96/2)
#define T0L	38 // low time for either bit (0.8 * 96/2)
#define T1L	10 // (0.2 * 96/2)
...
//    ESP_LOGI(TAG, "LED %u: bits_to_send = 0x%08X", led, bits_to_send);
...
//      ESP_LOGI(TAG, "  Bit %u: %s (mask: 0x%08X)", bit, bit_is_set ? "SET" : "UNSET", mask);
