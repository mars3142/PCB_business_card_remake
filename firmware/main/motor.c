...
#define MOTOR_HAPTIC_FWD_GPIO        4
#define MOTOR_HAPTIC_BWD_GPIO        5
...
void motor_init(void){
    ...
    configure_motor_pwm(MOTOR_HAPTIC_FWD_GPIO, LEDC_CHANNEL_0);
    configure_motor_pwm(MOTOR_HAPTIC_BWD_GPIO, LEDC_CHANNEL_1);
...
void soft_start_motor(int motor_index, int target_speed, bool target_direction)
{
    ...
    static bool current_direction[NUM_MOTORS] = {true};
